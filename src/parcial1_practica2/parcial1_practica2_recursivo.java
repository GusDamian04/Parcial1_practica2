 ...
 * @author GusDamian
 */
public class parcial1_practica2_recursivo {
    private static int ComunDivisor(int numayor, int numenor){
        int resuldiv, resulresi;
        if(numayor % numenor != 0){
            return numenor;
        } else {
            ...
            numayor = numenor;
            numenor = resulresi;
            return ComunDivisor(numenor, numayor);
        }
    ...
    public static void main(String[] args) throws IOException {
        ...
        numenor = ComunDivisor(numayor, numenor);
